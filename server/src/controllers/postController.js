...
exports.toggleLike = async (req, res) => {
    ...
    try {
        ...
        if (existingLike.length > 0) {
            ...
            await pool.query("DELETE FROM likes WHERE id = ?", [
                existingLike[0].id,
            ]);
            res.status(200).json({
        ...
        res.status(500).json({
            message: "Erro interno do servidor ao curtir/descurtir post.",
        });
    }
};
...
exports.toggleFavorite = async (req, res) => {
    ...
    try {
        ...
        if (existingFavorite.length > 0) {
            ...
            await pool.query("DELETE FROM favorites WHERE id = ?", [
                existingFavorite[0].id,
            ]);
            res.status(200).json({
        ...
        res.status(500).json({
            message: "Erro interno do servidor ao favoritar/desfavoritar post.",
        });
    }
};
...
exports.searchPosts = async (req, res) => {
  ...
  `;
    ...
    try {
        ...
        res.status(500).json({
            message: "Erro interno do servidor ao buscar/pesquisar posts.",
        });
    }
};
